...
public class RandomUtils {
    ...
    public static String randomChineseName() {
        boolean simple = RandomUtil.randomBoolean();
        return randomChineseName(simple);
    }

    /**
     * 随机生成中文名
     *
     * @param simple true：单字姓， false：复姓
     * @return
     */
    public static String randomChineseName(boolean simple) {
        String surName[] = {
        ...
        String[] word = {"一", "乙", "二", "十", "丁", "厂", "七", "卜", "人", "入", "八", "九", "几", "儿", "了", "力", "乃", "刀", "又",
                ...
                "怨", "急", "饶", "蚀", "饺", "饼", "弯", "将", "奖", "哀", "亭", "亮", "度", "迹", "庭", "疮", "疯", "疫",
                ...
                "眉", "孩", "除", "险", "院", "娃", "姥", "姨", "姻", "娇", "怒", "架", "贺", "盈", "勇", "怠", "柔", "垒",
                "绒", "结", "绕", "骄", "绘", "给", "络", "骆", "绝", "绞", "统", "耕", "耗", "艳", "泰", "珠", "班", "素",
    ...
    public static String randomStringWithoutConfusedChar(int length) {
        char[] chars = new char[]{'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'm', 'n', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', '1', '2', '3', '4', '5', '6', '7', '8', '9'};
    ...
    public static String randomOrderNo() {
        StringBuilder builder = new StringBuilder();
        builder.append(DateUtil.current(false)) //13
                .append(RandomUtil.randomNumbers(7)); // 7
        return builder.toString();
    }
