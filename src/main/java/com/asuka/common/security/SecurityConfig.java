...
import com.asuka.common.security.handler.LoginProcessingFilter;
import com.asuka.common.security.handler.PasswordEncoder;
import com.asuka.common.security.handler.UserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/swagger-ui.html", "/doc.html", "/webjars/**", "/v2/api-docs", "/swagger-resources/**").anonymous()
